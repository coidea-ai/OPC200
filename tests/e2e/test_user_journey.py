...
class TestUserJourney:
    ...
    def test_complete_journal_workflow(self, temp_dir):
        ...
        entries = [
            JournalEntry(
                content="Started learning Python today",
                tags=["learning", "python"],
                metadata={"mood": "excited"}
            ),
            JournalEntry(
                content="Completed first Python project",
                tags=["achievement", "python"],
                metadata={"mood": "proud"}
            ),
            JournalEntry(
        ...
        activities = [
            {"timestamp": entry.created_at, "action": "journal_entry", "tags": entry.tags}
