...
│   │ • 紧急远程访问授权     │              │                        │   │
│   │                        │              │                        │   │
│   │ OPC-001 ~ OPC-150      │              │ OPC-151 ~ OPC-200      │   │
│   └────────────────────────┘              └────────────────────────┘   │
│                                                                         │
│   ┌─────────────────────────────────────────────────────────────┐      │
│   │                    支持中心 (Support Hub)                    │      │
...
| 阶段 | 目标 | 数量 |
|------|------|------|
| Sprint 1 | 本地客户 | 50个 (OPC-001~050) |
| Sprint 2 | 本地客户 | 50个 (OPC-051~100) |
| Sprint 3 | 本地客户 | 50个 (OPC-101~150) |
| Sprint 4 | 云端客户 | 35个 (OPC-151~185) |
| Sprint 5 | 云端客户 | 15个 (OPC-186~200) |
